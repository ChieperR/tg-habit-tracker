...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  { id: 10, date: '2026-05-07', text: '💬 Команда /feedback — расскажи что не работает, чего не хватает или просто поделись мыслями. Можно с текстом и/или скриншотом, потом подтверждаешь отправку. Эмин прочитает и при необходимости ответит сюда же' },
];
