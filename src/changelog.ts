...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  { id: 8, date: '2026-04-11', text: '✅ Быстрый старт — после создания привычки можно сразу отметить первое выполнение, не нужно искать её в списке' },
  { id: 9, date: '2026-05-07', text: '⏰ Пофикшен баг с напоминаниями привычек: если поставить время которое сегодня уже прошло, бот больше не отправляет уведомление мгновенно после настройки' },
];
