...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  { id: 14, date: '2026-05-15', text: '🧊 Пофикшен баг с двойной выдачей заморозок за один и тот же пятидневный milestone. Также удаление привычки больше не ломает общий стрик активности задним числом (история сохраняется)' },
];
