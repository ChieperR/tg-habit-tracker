...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  { id: 12, date: '2026-05-15', text: '📊 Пофикшена сетка активности в /stats: текущая неделя теперь всегда в правой колонке, видны все недавние отметки. До этого «свежие» дни могли вылетать за пределы графика и казаться, что галок нет' },
];
