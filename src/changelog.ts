...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  { id: 11, date: '2026-05-13', text: '🔥 Стрики сделаны более явными, в разных напоминаниях добавлена вариативность текстов. Добавлены заморозки за стрики, чтобы не так страшно было разочек пропустить привычку)' },
];
